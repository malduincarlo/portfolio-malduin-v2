...
export function NdaPreview({ children }: { children: ReactNode }) {
  return (
    ...
    >
      <div className="absolute inset-0 scale-[1.015] blur-[4px] brightness-[0.82] saturate-[0.85] transition duration-300 group-hover:blur-[5px] group-focus-within:blur-[5px]">
        {children}
      </div>
      <div className="absolute inset-0 bg-black/22" aria-hidden="true" />
      <div className="absolute inset-0 grid place-items-center opacity-0 transition duration-200 group-hover:opacity-100 group-focus-within:opacity-100">
